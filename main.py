...
bot_token = os.environ.get("TOKEN","6745269720:AAHmvcVOAaf22PJYPjYi35wjK_HHtSkeboQ") # Botunuzun Tokenini Girin.
sahib = os.environ.get("sahib", "TyexV2") # Sahiplik Hesabin Kullanıcı Adını Girin .
BOT_ID = int(os.environ.get("BOT_ID", "6745269720")) # Botunuzun İd'si ( Tokenin Başındaki Rakamları ) Girin .
DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://epiktv7:epiktv86@cluster0.ttyjqmj.mongodb.net/?retryWrites=true&w=majority") # MongoDB veritabanınızın url'si.
BOT_USERNAME = os.environ.get("BOT_USERNAME","MatrixTaggerBot") # Botunuzun kullanıcı adı.
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL","-4129371567")) # Botunuzun eylemleri kaydedeceği kayıt grubunun id'si.
...
OWNER_ID = int(os.environ.get("OWNER_ID","6409792055")) # Sahip hesabın id'si
